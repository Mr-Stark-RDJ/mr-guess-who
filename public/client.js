...
const hintText = document.getElementById("hintText"); // optional banner if present
...
function showResults(p) {
  ...
  youSecret.innerHTML = `<div class="pic"><img src="${imgFor(p.you.secret)}"/></div>
                         <div class="name">Your secret: ${nameFor(p.you.secret)}</div>`;
  oppSecret.innerHTML = `<div class="pic"><img src="${imgFor(p.opponent.secret)}"/></div>
